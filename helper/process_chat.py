...
from db.crud import get_or_create_conversation, save_sources
...
async def process_chat(conversation_id: str, user_id: str, message: str, files: list[UploadFile], excluded_urls: str):
    ...
    try:
        ...
        if not await get_or_create_conversation(conversation_id, user_id_obj):
        ...
        if has_files:
            ...
            try:
                ...
                #     else: successful_uploads.append(r)
            ...
            if not message.strip():
                yield sse_event("answer_ready", {
                    ...
                    "user": message,
                    "assistant": f"Got it! I've added {titles} to your knowledge base.",
                    "model_used": None,
                    "source": None
                })
                yield sse_event("done", {})
